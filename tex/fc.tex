...
The parallel reduction (figure \ref{parallel}) has two modes (ranged over by $M$):
...
we would need to parallelize the $\KwLet{}.\KwLet{}$ reduction,
because it is used many times on the left.
	\item
	If $\KwLet{}.\S > \KwLet{}.\KwLet{}$, then
