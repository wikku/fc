...
can be used to show a triangle property ${\Rap{} · \Par{cd}} ⊆ {\Par{}}$.
...
want to complete a diagram in one $\Par{}$ step, we now only have to show $b →^* a^●$.
...
However, confluence follows directly from decreasing diagrams with ${→^*_a} > {→^*_p} > {→^*_i}$.
