...
\begin{abstract}
	...
	We prove the reductions are semantics-preserving using a novel and much simpler approach that uses commutation instead of confluence.
	We prove confluence only in a subcalculus and describe the problems we encountered.
...
$${←^* · ↦^*} ⊆ {↦^* · ←^*}$$
Usually, proofs of adequacy 2 use confluence (commutation of $→$ with itself) and semi-standardization \cite{Plotkin75, crary2009}.
