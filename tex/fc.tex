...
\begin{enumerate}
	\item
		We can try to make the $\KwLet{}.\S$-$\KwLet{}.\KwLet{}$ sequence on the left
		smaller than the initial $\KwLet{}.\KwLet{}$.
		One approach is to parallelize the $\KwLet{}.\KwLet{}$ reduction (not easy),
		refine the order on $\KwLet{}.\KwLet{}$ by self-labeling
		ordered by $\KwLet{}.\S$
		($\KwLet{}.\KwLet{}^e > \KwLet{}.\KwLet{}^{e'}$ iff $e \xrightarrow{\KwLet{}.\S}^+ e'$),
		and set $\KwLet{}.\S < \KwLet{}.\KwLet{}^e$.
	\item
		We can order $\KwLet{}.\S$ reductions by themselves
		($\KwLet{}.\S^e > \KwLet{}.\S^{e'}$ iff $e \xrightarrow{\KwLet{}.\S}^+ e'$),
		and set $\KwLet{}.\KwLet{} < \KwLet{}.\S^e$.
\end{enumerate}
...
\begin{enumerate}
	\item
		...
		$$\Ask(⟨E╱v⟩) ↦ v$$
		% FIXME
		Working with the grammar $\Ask(κ)$ on paper is more convenient,
